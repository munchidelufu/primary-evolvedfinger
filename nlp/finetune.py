...
def fit(index, model, train_loader, dev_loader, test_loader):
    if index < 10:
        ...
        optimizer = torch.optim.Adam(model.lin.parameters(), lr=args.learning_rate)

    train(index, model, train_loader, dev_loader, optimizer)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_type", type=str, default="finetune_trigger")
