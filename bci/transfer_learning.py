...
def fit(
    ...
    loss_fn = CrossEntropyLoss()
    #
    save_dir = f"./model/transfer_learning/{args.model_name}/transfer_learning_{i}/"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_name", type=str, choices=["eegconformer"])
    ...
    #
    dataset = data_loader.load_mahnob_dataset(model_name=args.model_name)
    kfold = KFoldGroupbyTrial(n_splits=5, split_path=f"./data/mahnobhci/split")
    #
    for i in range(10):
