...
def fit(
    ...
    #
    save_dir = f"./model/model_extract_p/{args.teacher_name}_{args.student_name}/model_extract_{index}"
    ...
    for split_idx, (train_dataset, test_dataset) in enumerate(kfold.split(dataset)):
        ...
        loss, test_acc = val(stu_model, test_loader, loss_fn=val_loss_fn)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--student_name", type=str, choices=["eegconformer", "deepnet", "shallownet"]
    )
    ...
    # pair_kfold
    kfold = KFoldGroupbyTrial(
        n_splits=5, split_path=f"./data/{args.teacher_name}/attack"
    )
...
# nohup python model_extract_p.py --teacher_name ccnn --student_name mtcnn --gpu 4 &
# nohup python model_extract_p.py --teacher_name ccnn --student_name stnet --gpu 3 &
# nohup python model_extract_p.py --teacher_name ccnn --student_name fbccnn --gpu 4 &
# nohup python model_extract_p.py --teacher_name conformer --student_name eegnet --gpu 2 &
# nohup python model_extract_p.py --teacher_name conformer --student_name deepnet --gpu 3 &
# nohup python model_extract_p.py --teacher_name conformer --student_name shallownet --gpu 1 &
