...
def fine_prune(
    ...
    for i in range(int(np.floor(args.prune_amount * total_length))):
        ...
        if (
            ...
            save_dir = f"./model/fineprune_{args.prune_amount}/{args.model_name}"
    ...
    save_dir = f"./result/fineprune_{args.prune_amount}/{args.model_name}"
    if not os.path.exists(save_dir):
        os.makedirs(save_dir, exist_ok=True)
...
if __name__ == "__main__":
    ...
    # Set random seed to facilitate reproducible results
